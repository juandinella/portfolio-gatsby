...
const App = () => (
  <Layout>
    ...
    <Work
      ...
      description="In collaboration with the Sans Bureau team we were working on the redesign of the Satellogic website."
    ...
    <Work
      ...
      description="I had the pleasure to work with this great hostel making a redesign and the frontend of their new website."
    ...
    <Work
      ...
      description="Leo requested me to create a landing page for his brand new book, Soy solo. He wanted a simple, clean, fast website and I designed and developed one for him."
    ...
    <Work
      ...
      description="Since Neolo is constantly growing and expanding, its website needed to be able to adapt to their necessities and be responsive to that. My role in this project was to redesign the complete experience, create a new UI and develop the frontend."
